...
`), font: Wt, pos: S(e, -e), anchor: "botleft", size: 16, width: be() * 0.6, lineSpacing: e / 2, fixed: true, styles: { time: { color: J(127, 127, 127) }, info: { color: J(255, 255, 255) }, error: { color: J(255, 0, 127) } } });
  ...
  var require_main = __commonJS({
    "code/main.ts"(exports) {
      init_kaboom();
      bo();
      var L$ = /* @__PURE__ */ __name((url = "") => location.href + url, "L$");
      {
        resFont = /* @__PURE__ */ __name((..._0) => __async(exports, [..._0], function* (fontName = "", as = fontName) {
          return loadFont(
            as,
            L$("code/fonts/" + fontName + ".ttf")
          );
        }), "resFont");
        handleRubik = /* @__PURE__ */ __name((instance = "") => __async(exports, null, function* () {
      ...
      __name(sToMs, "sToMs");
      function drainOpacity(sprite, duration) {
        return __async(this, null, function* () {
      ...
      function makeIntroTransition(color2, time2 = 2) {
        return __async(this, null, function* () {
          let fg = yield createFG();
          if (color2)
            fg.use(color2);
          yield drainOpacity(fg, sToMs(time2));
          fg.destroy();
          return fg;
        });
      }
          ...
          let om = {
            ...
            bottomRight: {
              ...
              update: requestAnimationFrame(/* @__PURE__ */ __name(function temp() {
                ...
                let t = new Date();
                let time2 = t.toLocaleDateString() + "   |   " + t.toLocaleTimeString();
                om.bottomRight.time.text = time2;
              }, "temp"))
            },
            tweenUp() {
              return __async(this, null, function* () {
      ...
      scene("intro", () => __async(exports, null, function* () {
        ...
        yield makeIntroTransition(rgb(0, 0, 0), 25);
